...
## Features
- 16 playable chapters, plus 3 gaidens
- Voice clips
- Unit randomisation
...
## Known Issues
- Stats do not properly change when units are forcibly dismounted before an
  indoor map, or mounted after its completion. While these broadly cancel each
  other out, it is possible to gain or lose stats with poor timing.
  The command itself functions properly, as do movement adjustments.
...
## Notes
- This release is gameplay complete up to Chapter 16. The storyline is also
  fully written assuming the player achieves all storyline objectives and
  keeps everyone alive, but placeholder text may appear if some are missed.
- All proper nouns are spelled as they are out of personal preference.
  They will not be changed, and please refrain from asking about it.
- Dialogue is written in British English. Please keep this in mind when
  reporting any typos.
- Testing was done in mGBA and VBA. Use any other emulator at your own risk.
  Mobile emulators are not supported.
- While attempts have been made to mitigate this, knowledge of the stories of
  FE1 and 3 is highly recommended. Knowledge of FE2, FE6 and 7, and Engage 
  are also recommended to a lesser degree.
- DSFE save points are present. They replace suspend, so be wary when finishing
  a gameplay session.
...
- Chapters 13 to 16 added.
- Also added three gaiden chapters: 5x, 10x, and 13x.
- Added 41 new characters to the summon pool, with six new series added.
- Added three support chains.
- Replaced many Fire Emblem requantisations with proper portraits.
- Replaced many UI elements with FE3-inspired ones.
- Added a choice to forego summoning entirely and play a more traditional
  campaign with canon Fire Emblem characters.
